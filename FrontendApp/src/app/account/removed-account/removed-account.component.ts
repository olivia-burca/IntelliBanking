...
@Component({
  selector: 'app-removed-account',
  templateUrl: './removed-account.component.html',
  styleUrls: ['./removed-account.component.css']
})
export class RemovedAccountComponent implements OnInit {

  public removedAccounts: Account[];
  public rejectedAccounts: Account[];
  ...
  ngOnInit(): void {
    ...
    this.getRemovedAccounts();
  }

  public getRemovedAccounts(): void {
    this.accountService.getRemovedAccounts().subscribe(
      (response: Account[]) => {
        this.removedAccounts = response;
        console.log(this.removedAccounts);
        this.accountService.getRejectedAccounts().subscribe(
          (response: Account[]) => {
            this.removedAccounts = this.removedAccounts.concat(response);
            console.log(this.removedAccounts);
            this.dataSource = new MatTableDataSource(this.removedAccounts);
